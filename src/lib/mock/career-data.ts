...
export const MOCK_JOBS: JobListing[] = [
  {
    ...
    titleLocalized: "مهندس منتج — Flutter (مستوى II)",
  ...
  },
  {
    ...
    titleLocalized: "مهندس برمجيات iOS",
  ...
  },
  {
    ...
    titleLocalized: "مهندس برمجيات — تطبيقات الجوال",
    location: "Remote · GCC",
    remote: true,
  ...
  },
  {
    ...
    companyLogo: "S",
    title: "AI Engineer",
    titleLocalized: "مهندس ذكاء اصطناعي",
    location: "Riyadh, Saudi Arabia",
    remote: false,
    employmentType: "hybrid",
    matchScore: 79,
